...
def test_filters_methods():
    ...
    def __lpf():
        lpf = Processing.lpf(fc_lpf, m_lpf, dt)
        tf_lpf = Analysis.transferFunction(lpf, m_lpf)
        filtered_data = Model.convolModel(lpf, data, N)
    ...
    fc_lpf, fc_hpf, fc1_bpf, fc2_bpf, fc1_bsf, fc2_bsf = 20, 300, 80, 200, 80, 200
